...
public class News implements Serializable {
    ...
    /** 资讯的唯一标识ID。 */
    @Schema(description = "资讯的唯一标识ID")
    private Integer id;

    /** 资讯的标题，简要概述资讯内容。 */
    @Schema(description = "资讯的标题")
    private String title;

    /** 资讯的简介，对资讯内容进行简短描述。 */
    @Schema(description = "资讯的简介")
    private String descr;

    /** 资讯的详细内容。 */
    @Schema(description = "资讯的详细内容")
    private String content;

    /** 资讯的封面图片路径或URL，用于展示在列表或详情页面。 */
    @Schema(description = "资讯的封面图片路径或URL")
    private String cover;

    /** 资讯的发布时间，通常为日期时间字符串格式。 */
    @Schema(description = "资讯的发布时间")
    private String time;

    /** 资讯被浏览的次数，记录用户访问量。 */
    @Schema(description = "资讯被浏览的次数")
    private Integer count;

    /** 资讯所属的分类，如新闻、公告、活动等。 */
    @Schema(description = "资讯所属的分类")
